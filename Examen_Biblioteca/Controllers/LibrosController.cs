...
namespace Examen_Biblioteca.Controllers
{
    public class LibrosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Titulo,Autor,Genero,AnioPublicacion")] Libros libros)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Titulo,Autor,Genero,AnioPublicacion")] Libros libros)
        {
            if (id != libros.Id)
            {
                return NotFound();
